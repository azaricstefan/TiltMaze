...
public class GameActivity extends Activity
    ...
    public void onBackPressed() {
        ...
        if (!model.isGameOver()) {
            getController().getModel().setGameTime((long) gameTime + (System.currentTimeMillis() - startTime) / 1000);
            getController().getModel().savePolygon("TEMP:" + filterTmp(controller.getNameOfPolygonToLoad()) + ":tmp", this);
        }
    }
    ...
    public DbOperationsHelper getDbOperationsHelper() {
        return dbOperationsHelper;
    }
    ...
    public float getGameTime() {
        return gameTime + (((float) (endTime - startTime)) / 1000f);
    }
